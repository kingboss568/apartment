...
//  公寓大廈管理條例全圖解
//
//  Law lookup and official architecture/civil engineering resource hub.
//
...
struct RegulatoryResourcesView: View {
    ...
    private let quickTerms = ["區分所有", "公共基金", "管委會", "規約", "欠費", "罰鍰"]
    ...
    private var resourceSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            SectionTitle(title: "常用公寓管理網站", subtitle: "\(resourceMatches.count) 個官方入口")
            categoryFilter
    ...
    private var disclaimer: some View {
        HStack(alignment: .top, spacing: 9) {
            ...
            Text("本 App 提供公寓大廈管理條例圖解、題庫與速查輔助，實際社區決議、催繳、修繕、移交、裁罰與訴訟仍應以主管機關最新公告、全國法規資料庫與正式法律意見為準。")
...
private struct ResourceLinkRow: View {
    ...
    private var categoryColor: Color {
        ...
        case .local: return AppTheme.leaf
