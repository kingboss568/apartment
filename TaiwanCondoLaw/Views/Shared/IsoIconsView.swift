...
enum IsoIconKind {
    ...
    case boxBand       // Ch02 共用部分
    case stairSmall    // Ch03 公共基金
    case flame         // Ch04 會議與規約
    case parking       // Ch05 管理委員會
    case wheelchair    // Ch06 管理服務人
    case columnSmall   // Ch07 起造人移交
    case gear          // Ch08 罰則與爭議

    // ─── 常用卡（64×64 viewBox）
    case favDesign     // 權利義務
    case favFire       // 會議規約
    case favAccess     // 住戶義務
    case favParking    // 停車與共用
    case favVent       // 修繕維護
    case favGreen      // 公共基金
    case favStruct     // 移交文件
    case favEquip      // 罰則爭議

    // ─── Utility icons（48×48 viewBox）
    case calcBox       // 題庫
    case calcWindow    // 檢核
    case calcSlab      // 文件
    case calcStairs    // 流程
